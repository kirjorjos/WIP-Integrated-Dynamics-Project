...
type TypeInteger = InstanceType<typeof IntegratedDynamicsClasses.Number> & { dataType: "Integer" };
type TypeLong = InstanceType<typeof IntegratedDynamicsClasses.Number> & { dataType: "Long" };
type TypeDouble = InstanceType<typeof IntegratedDynamicsClasses.Number> & { dataType: "Double" };
type TypeNumber = TypeInteger | TypeLong | TypeDouble;
...
class IntegratedDynamicsClasses {
  ...
  static Operator = class Operator extends Function {
    ...
    constructor({ internalName, nicknames, parsedSignature, rawSignature, symbol, interactName, function: fn }: { internalName: string; nicknames: string[]; symbol: string; interactName: string; function: (...args: any[]) => any } & ({ rawSignature: TypeOperator; parsedSignature?: never } | { rawSignature?: never; parsedSignature: InstanceType<typeof IntegratedDynamicsClasses.ParsedSignature> })) {
