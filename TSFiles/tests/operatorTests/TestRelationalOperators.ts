...
describe('TestRelationalOperators', () => {
    ...
    test('testInvalidInputTypeGT', () => {
        expect(() => {
            new operatorRegistry.RELATIONAL_GT().evaluate(DUMMY_VARIABLE_STRING, DUMMY_VARIABLE_STRING);
        }).toThrow();
    });
    ...
    test('testInvalidInputTypeLT', () => {
        expect(() => {
            new operatorRegistry.RELATIONAL_LT().evaluate(DUMMY_VARIABLE_STRING, DUMMY_VARIABLE_STRING);
        }).toThrow();
    });
    ...
    test('testInvalidInputTypeGE', () => {
        expect(() => {
            new operatorRegistry.RELATIONAL_GE().evaluate(DUMMY_VARIABLE_STRING, DUMMY_VARIABLE_STRING);
        }).toThrow();
    });
    ...
    test('testInvalidInputTypeLE', () => {
        expect(() => {
            new operatorRegistry.RELATIONAL_LE().evaluate(DUMMY_VARIABLE_STRING, DUMMY_VARIABLE_STRING);
        }).toThrow();
    });
});
