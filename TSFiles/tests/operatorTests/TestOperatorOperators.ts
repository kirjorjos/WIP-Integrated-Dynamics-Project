...
describe("TestOperatorOperators", () => {
    ...
    beforeEach(() => {
        ...
        oArithmeticMultiplication = new operatorRegistry.ARITHMETIC_MULTIPLICATION();
    ...
    it("testApply", () => {
        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(oGeneralIdentity, bFalse);
        expect(res1).toBeInstanceOf(iBoolean);
        expect((res1 as iBoolean).bool).toBe(false);

        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(oGeneralIdentity, bTrue);
        expect((res2 as iBoolean).bool).toBe(true);

        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalNot, bTrue);
        expect((res3 as iBoolean).bool).toBe(false);

        const res4 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalNot, bFalse);
        expect((res4 as iBoolean).bool).toBe(true);
    });

    it("testApplyCurring", () => {
        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAnd, bTrue);
        expect(res1).toBeInstanceOf(Operator);

        const oLogicalAndCurriedTrue = res1 as Operator<any, any>;
        const res2_1 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAndCurriedTrue, bTrue);
        expect(res2_1).toBeInstanceOf(iBoolean);
        expect((res2_1 as iBoolean).bool).toBe(true);
        const res2_2 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAndCurriedTrue, bFalse);
        expect((res2_2 as iBoolean).bool).toBe(false);

        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAnd, bFalse);
        expect(res3).toBeInstanceOf(Operator);

        const oLogicalAndCurriedFalse = res3 as Operator<any, any>;
        const res4_1 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAndCurriedFalse, bTrue);
        expect(res4_1).toBeInstanceOf(iBoolean);
        expect((res4_1 as iBoolean).bool).toBe(false);
        const res4_2 = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAndCurriedFalse, bFalse);
        expect((res4_2 as iBoolean).bool).toBe(false);
    });

    it("testInvalidInputSizeApplyLarge", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY().evaluate(oGeneralIdentity, bFalse, bFalse);
        }).toThrow();
    });

    it("testInvalidInputSizeApplyCurryingLarge", () => {
        const curriedOperatorValue = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAnd, bTrue);
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY().evaluate(curriedOperatorValue, bFalse, bFalse);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorInputTypeApply", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalNot, oGeneralIdentity);
        }).toThrow();
    });
    ...
    it("testConditionalOutputTypesApplyCurring", () => {
        const curriedOperatorValue = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAnd, bTrue);
        const curriedSignature = (curriedOperatorValue as Operator<any, any>).getParsedSignature();
        expect(curriedSignature.getArity()).toBe(1);
        expect(curriedSignature.getInput(0).type).toBe('Boolean');
        expect(curriedSignature.getOutput().type).toBe('Boolean');
    });
    ...
    it("testApply2", () => {
        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oLogicalAnd, bTrue, bFalse);
        expect(res1).toBeInstanceOf(iBoolean);
        expect((res1 as iBoolean).bool).toBe(false);

        const res2 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oLogicalAnd, bTrue, bTrue);
        expect((res2 as iBoolean).bool).toBe(true);

        const res3 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oRelationalGreaterThan, i0, i1);
        expect((res3 as iBoolean).bool).toBe(false);

        const res4 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oRelationalGreaterThan, i2, i1);
        expect((res4 as iBoolean).bool).toBe(true);
    });

    it("testApply2OnOpWith3Inputs", () => {
        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oChoice, bTrue, i1);
        expect(res1).toBeInstanceOf(Operator);
        expect((res1 as Operator<any, any>).getParsedSignature().getArity()).toBe(1);
        expect((res1 as Operator<any, any>).getParsedSignature().getInput(0).type).toBe("Any");
        expect((res1 as Operator<any, any>).getParsedSignature().getOutput(-1).type).toBe("Any");
    ...
    it("testInvalidInputSizeApply2Large", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY_2().evaluate(oLogicalAnd, bFalse, bFalse, bFalse);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorInputTypeApply2", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY_2().evaluate(oLogicalNot, oGeneralIdentity, bTrue);
        }).toThrow();
    });
    ...
    it("testApply3", () => {
        const res1 = new operatorRegistry.OPERATOR_APPLY_3().evaluate(oSubStr, i0, i1, sAnd);
    ...
    it("testApply3ThreeAnd", () => {
        ...
        const oThreeAnd_1 = new operatorRegistry.OPERATOR_APPLY().evaluate(oPipeFlip, oLogicalAnd);
        const oThreeAnd = new operatorRegistry.OPERATOR_APPLY_2().evaluate(oPipeFlip, oThreeAnd_1, oLogicalAnd);

        const res1 = new operatorRegistry.OPERATOR_APPLY_3().evaluate(oThreeAnd, bTrue, bTrue, bTrue);
        expect(res1).toBeInstanceOf(iBoolean);
    ...
    it("testApplyN", () => {
        ...
        const res1 = new operatorRegistry.OPERATOR_APPLY_N().evaluate(oSubStr, applyArgs);
        expect(res1).toBeInstanceOf(iString);
        expect((res1 as iString).valueOf()).toBe("i");
    });
    ...
    it("testInvalidInputSizeApplyNLarge", () => {
        const applyArgs = new iArrayEager([i0, i1, sAnd]);
        expect(() => {
            new operatorRegistry.OPERATOR_APPLY_N().evaluate(oSubStr, applyArgs, applyArgs);
        }).toThrow();
    });
    ...
    it("testMap", () => {
        const res1 = new operatorRegistry.OPERATOR_MAP().evaluate(oArithmeticIncrement, lintegers);
        ...
        const res2 = new operatorRegistry.OPERATOR_MAP().evaluate(oLogicalNot, lbooleans);
        ...
        const curriedOperatorValue = new operatorRegistry.OPERATOR_APPLY().evaluate(oLogicalAnd, bTrue);
        const res3 = new operatorRegistry.OPERATOR_MAP().evaluate(curriedOperatorValue, lbooleans);
        ...
        const res4 = new operatorRegistry.OPERATOR_MAP().evaluate(oLogicalAnd, lbooleans);
    ...
    it("testInvalidInputSizeMapLarge", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_MAP().evaluate(oArithmeticIncrement, lintegers, lintegers);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorInputTypeMap", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_MAP().evaluate(oArithmeticIncrement, oArithmeticIncrement);
        }).toThrow();
    });
    ...
    it("testPredicateConjunction", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        const twoGreaterThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalGreaterThan, i2);
        const zeroLessThanandTwoGreaterThan = new operatorRegistry.OPERATOR_CONJUNCTION().evaluate(zeroLessThan, twoGreaterThan);

        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanandTwoGreaterThan, i0);
        expect(res1).toBeInstanceOf(iBoolean);
        expect((res1 as iBoolean).bool).toBe(false);
        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanandTwoGreaterThan, i1);
        expect((res2 as iBoolean).bool).toBe(true);
        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanandTwoGreaterThan, i2);
        expect((res3 as iBoolean).bool).toBe(false);
    });
    ...
    it("testInvalidInputSizePredicateConjunctionLarge", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        expect(() => {
            new operatorRegistry.OPERATOR_CONJUNCTION().evaluate(zeroLessThan, zeroLessThan, zeroLessThan);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorTypePredicateConjunction", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        expect(() => {
            new operatorRegistry.OPERATOR_CONJUNCTION().evaluate(bFalse, zeroLessThan);
        }).toThrow();
    });

    it("testInvalidOperatorInputTypePredicateConjunction", () => {
        const equalsTwo = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalEquals, i2);
        expect(() => {
    ...
    it("testPredicateDisjunction", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        const twoGreaterThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalGreaterThan, i2);
        const zeroLessThanorTwoGreaterThan = new operatorRegistry.OPERATOR_DISJUNCTION().evaluate(zeroLessThan, twoGreaterThan);

        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanorTwoGreaterThan, i0);
        expect(res1).toBeInstanceOf(iBoolean);
        expect((res1 as iBoolean).bool).toBe(true);
        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanorTwoGreaterThan, i1);
        expect((res2 as iBoolean).bool).toBe(true);
        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(zeroLessThanorTwoGreaterThan, i2);
    ...
    it("testInvalidInputSizePredicateDisjunctionLarge", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        expect(() => {
            new operatorRegistry.OPERATOR_DISJUNCTION().evaluate(zeroLessThan, zeroLessThan, zeroLessThan);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorTypePredicateDisjunction", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        expect(() => {
            new operatorRegistry.OPERATOR_DISJUNCTION().evaluate(bFalse, zeroLessThan);
        }).toThrow();
    });
    ...
    it("testPredicateNegation", () => {
        const twoGreaterThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalGreaterThan, i2);
        const notTwoGreaterThan = new operatorRegistry.OPERATOR_NEGATION().evaluate(twoGreaterThan);

        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(notTwoGreaterThan, i0);
        expect(res1).toBeInstanceOf(iBoolean);
        expect((res1 as iBoolean).bool).toBe(false);
        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(notTwoGreaterThan, i1);
        expect((res2 as iBoolean).bool).toBe(false);
        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(notTwoGreaterThan, i2);
        expect((res3 as iBoolean).bool).toBe(true);
        const res4 = new operatorRegistry.OPERATOR_APPLY().evaluate(notTwoGreaterThan, i3);
        expect((res4 as iBoolean).bool).toBe(true);
    });
    ...
    it("testInvalidInputSizePredicateNegationLarge", () => {
        const zeroLessThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalLessThan, i0);
        expect(() => {
            new operatorRegistry.OPERATOR_NEGATION().evaluate(zeroLessThan, zeroLessThan);
        }).toThrow();
    });
    ...
    it("testPredicatePipe", () => {
        const increment2 = new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticIncrement, oArithmeticIncrement2);
    ...
    it("testPredicatePipe3Incr", () => {
        const innerPipe = new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticIncrement, oArithmeticIncrement2);
        const op = new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticIncrement, innerPipe) as Operator<any, any>;

        const signature = op.getParsedSignature();
        expect(signature.getArity()).toBe(1);
        expect(signature.getInput(0).type).toBe('Number');
        expect(signature.getOutput(-1).type).toBe('Number');
        expect(signature.getOutput().type).toBe('Number');
    ...
    it("testPredicatePipeAddAddError", () => {
        const op = new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticAddition, oArithmeticAddition2);
        expect(() => {
    ...
    it("testPredicatePipeMapContains", () => {
        const mapContains = new operatorRegistry.OPERATOR_PIPE().evaluate(oListContains, oOperatorMap);

        const signature = (mapContains as Operator<any,any>).getParsedSignature();
        expect(signature.getArity()).toBe(2);
        expect(signature.getInput(0).type).toBe('List');
        expect(signature.getInput(1).type).toBe('List');
        expect(signature.getOutput(-1).type).toBe('List');
        expect(signature.getOutput().type).toBe('List');

        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(mapContains, lintegers, lintegers);
        expect(res1).toBeInstanceOf(iArrayEager);
        const expected = new iArrayEager([new iBoolean(true), new iBoolean(true), new iBoolean(true), new iBoolean(true)]);
        expect(res1.equals(expected).bool).toBe(true);
    });

    it("testPredicatePipeLargeInputCount", () => {
        const incrementAndAdd = new operatorRegistry.OPERATOR_PIPE().evaluate(oParseInt, oArithmeticAddition);
        expect((incrementAndAdd as Operator<any,any>).getParsedSignature().getArity()).toBe(2);
        const sig = (incrementAndAdd as Operator<any,any>).getParsedSignature();
        expect(sig.getInput(0).type).toBe("String");
        expect(sig.getInput(1).type).toBe("Number");
        expect(sig.getOutput(-1).type).toBe("Number");
        expect(sig.getOutput().type).toBe("Number");

        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(incrementAndAdd, s1, i2);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(3);
    });

    it("testPredicatePipeMixed", () => {
        const listLengthIncr = new operatorRegistry.OPERATOR_PIPE().evaluate(oListLength, oArithmeticAddition) as Operator<any, any>;

        const signature = listLengthIncr.getParsedSignature();
        expect(signature.getArity()).toBe(2);
        expect(signature.getInput(0).type).toBe('List');
        expect(signature.getInput(1).type).toBe('Number');
        expect(signature.getOutput(-1).type).toBe('Number');
        expect(signature.getOutput().type).toBe('Number');

        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(listLengthIncr, lintegers, i2);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(6);
    });

    it("testPredicatePipeLenAddMap", () => {
        const innerPipe = new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticAddition, oOperatorMap);
        const op = new operatorRegistry.OPERATOR_PIPE().evaluate(oListLength, innerPipe) as Operator<any, any>;
        ...
        const res1 = new operatorRegistry.OPERATOR_APPLY_2().evaluate(op, lintegers, lintegers);
        expect(res1).toBeInstanceOf(iArrayEager);
        const expected = new iArrayEager([new Integer(4), new Integer(5), new Integer(6), new Integer(7)]);
        expect(res1.equals(expected).bool).toBe(true);
    });

    it("testInvalidInputSizePredicatePipeLarge", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_PIPE().evaluate(oArithmeticIncrement, oArithmeticIncrement, oArithmeticIncrement);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorTypePredicatePipe", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_PIPE().evaluate(bFalse, oArithmeticIncrement);
        }).toThrow();
    });
    ...
    it("testPredicatePipe2", () => {
        const addOneAndSelfMultiply = new operatorRegistry.OPERATOR_PIPE2().evaluate(oGeneralIdentity, oArithmeticIncrement, oArithmeticMultiplication) as Operator<any, any>;
        ...
        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(addOneAndSelfMultiply, i0);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(0);
        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(addOneAndSelfMultiply, i1);
        expect((res2 as Integer).toJSNumber()).toBe(2);
        const res3 = new operatorRegistry.OPERATOR_APPLY().evaluate(addOneAndSelfMultiply, i2);
        expect((res3 as Integer).toJSNumber()).toBe(6);
        const res4 = new operatorRegistry.OPERATOR_APPLY().evaluate(addOneAndSelfMultiply, i3);
    ...
    it("testPredicateFlip", () => {
        const lessThanFlipped = new operatorRegistry.OPERATOR_FLIP().evaluate(oRelationalLessThan);
        const lessThan2 = new operatorRegistry.OPERATOR_APPLY().evaluate(lessThanFlipped, i2);
    ...
    it("testPredicateFlipOperatorWithThreeInputs", () => {
        const choiceFlipped = new operatorRegistry.OPERATOR_FLIP().evaluate(oChoice);
        const choiceFlipped0 = new operatorRegistry.OPERATOR_APPLY().evaluate(choiceFlipped, i0);
        const choiceFlipped0False = new operatorRegistry.OPERATOR_APPLY().evaluate(choiceFlipped0, bFalse);
        const choiceFlipped0True = new operatorRegistry.OPERATOR_APPLY().evaluate(choiceFlipped0, bTrue);

        const res1 = new operatorRegistry.OPERATOR_APPLY().evaluate(choiceFlipped0False, i1);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(1);
        const res2 = new operatorRegistry.OPERATOR_APPLY().evaluate(choiceFlipped0True, i1);
        expect((res2 as Integer).toJSNumber()).toBe(0);
    });

    it("testInvalidInputSizePredicateFlipLarge", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_FLIP().evaluate(oRelationalLessThan, oRelationalLessThan);
        }).toThrow();
    });
    ...
    it("testFilter", () => {
        ...
        const res1 = new operatorRegistry.OPERATOR_FILTER().evaluate(equalsTwo, lintegers);
        expect(res1).toBeInstanceOf(iArrayEager);
        const list1 = res1 as iArray<Integer>;
        ...
        const twoGreaterThan = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalGreaterThan, i2);
        const zeroLessThanandTwoGreaterThan = new operatorRegistry.OPERATOR_CONJUNCTION().evaluate(zeroLessThan, twoGreaterThan);
        const res2 = new operatorRegistry.OPERATOR_FILTER().evaluate(zeroLessThanandTwoGreaterThan, lintegers);
    ...
    it("testFilterEvenNumbers", () => {
        const modulusFlipped = new operatorRegistry.OPERATOR_FLIP().evaluate(oArithmeticModulus);
        const modulus2 = new operatorRegistry.OPERATOR_APPLY().evaluate(modulusFlipped, i2);
        const isZero = new operatorRegistry.OPERATOR_APPLY().evaluate(oRelationalEquals, i0);
        const isEvenUnsafe = new operatorRegistry.OPERATOR_PIPE().evaluate(modulus2, isZero);
        const isEven = new operatorRegistry.OPERATOR_DISJUNCTION().evaluate(isZero, isEvenUnsafe);
        const res3 = new operatorRegistry.OPERATOR_FILTER().evaluate(isEven, lintegers);
    ...
    it("testInvalidInputSizeFilterLarge", () => {
        ...
        expect(() => {
            new operatorRegistry.OPERATOR_FILTER().evaluate(equalsTwo, lintegers, lintegers);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorInputTypeFilter", () => {
        ...
        expect(() => {
            new operatorRegistry.OPERATOR_FILTER().evaluate(equalsTwo, oArithmeticIncrement);
        }).toThrow();
    });
    ...
    it("testReduce", () => {
        const res1 = new operatorRegistry.OPERATOR_REDUCE().evaluate(oArithmeticAddition, lintegers, i0);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(6);
    });
    ...
    it("testInvalidInputSizeReduceLarge", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE().evaluate(oArithmeticAddition, lintegers, i0, i0);
        }).toThrow();
    });

    it("testInvalidInputSizeReduceSmall", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE().evaluate(oArithmeticAddition, lintegers);
        }).toThrow();
    });
    ...
    it("testInvalidOperatorInputTypeReduce", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE().evaluate(oArithmeticAddition, i0, i0);
        }).toThrow();
    });

    it("testInvalidOperatorAccumulatorTypeReduce", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE().evaluate(oArithmeticAddition, lintegers, lintegers);
        }).toThrow();
    });
    ...
    it("testReduce1", () => {
        const res1 = new operatorRegistry.OPERATOR_REDUCE1().evaluate(oArithmeticAddition, lintegers);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(6);
    });

    it("testReduce1Complex", () => {
        const flippedChoice = new operatorRegistry.OPERATOR_FLIP().evaluate(oChoice);
        const pipedFlip = new operatorRegistry.OPERATOR_PIPE().evaluate(flippedChoice, new operatorRegistry.OPERATOR_FLIP());
        const appliedPipe2 = new operatorRegistry.OPERATOR_APPLY().evaluate(new operatorRegistry.OPERATOR_PIPE2(), oGeneralIdentity);
        ...
        const res1 = new operatorRegistry.OPERATOR_REDUCE1().evaluate(reducer, lintegers);
        expect(res1).toBeInstanceOf(Integer);
        expect((res1 as Integer).toJSNumber()).toBe(3);
    });
    ...
    it("testInvalidInputSizeReduce1Large", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE1().evaluate(oArithmeticAddition, lintegers, i0);
        }).toThrow();
    });
    ...
    it("testInvalidEmptyListReduce1", () => {
        expect(() => {
            new operatorRegistry.OPERATOR_REDUCE1().evaluate(oArithmeticAddition, lempty);
        }).toThrow();
    });
    ...
    it("testByName", () => {
        ...
        expect(res1).toBeInstanceOf(Operator);
        expect((res1 as BaseOperator<any,any>).getUname()).toBe("integrateddynamics:logical_and");
    });
