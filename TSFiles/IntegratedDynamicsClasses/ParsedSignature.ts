import { TypeOperator, TypeFunction, TypeConcrete, TypeGeneric, TypeAny, TypeList, TypeTypeMap } from "../types";
...
export class ParsedSignature {
    ...
    constructor(ast: TypeOperator | TypeList | TypeAny | TypeConcrete | TypeFunction | TypeGeneric, typeMap: TypeMap = new TypeMap()) {
    ...
    apply(argType: TypeFunction | TypeAny | TypeConcrete | TypeGeneric | TypeList): ParsedSignature {
      if (this.ast.kind !== "Function") {
