 ...
 */
export class NbtPathExpressionParseHandlerFilterExpression implements INbtPathExpressionParseHandler {
    ...
    public handlePrefixOf(nbtPathExpression: string, pos: number): HandleResult {
        ...
        try {
            ...
            return new HandleResult(new NbtPathExpressionParseHandlerFilterExpression.Expression(expression!),
