 ...
 */
export class NbtPathExpressionParseHandlerCurrent implements INbtPathExpressionParseHandler {
    ...
    public handlePrefixOf(nbtPathExpression: string, pos: number): HandleResult {
        ...
        return new HandleResult(NbtPathExpressionParseHandlerCurrent.Expression.INSTANCE, 1);
    }
