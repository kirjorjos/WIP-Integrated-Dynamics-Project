 ...
 */
export class NbtPathExpressionParseHandlerUnion implements INbtPathExpressionParseHandler {
...
class Expression extends INbtPathExpression {
    ...
    override asNavigation(child: INbtPathNavigation): INbtPathNavigation {
        if (!(this.getChildNames().length == 0)) {
            ...
            throw new Error("NbtPathExpressionParseHandlerUnion.Expression#asNavigation is not implemented for lists");
        }
    }
}
