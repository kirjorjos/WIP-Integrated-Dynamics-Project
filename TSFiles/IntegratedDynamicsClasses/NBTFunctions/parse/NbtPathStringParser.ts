...
export class NbtPathStringParser {
    static StringParseResult = class StringParseResult {
        private static FAIL = new StringParseResult(false, 0, "") as StringParseResult;
     ...
     * @return Parse result
     */
    public static parse(source: string, pos: number): InstanceType<typeof this.StringParseResult> {
        ...
        while (true) {
            ...
            switch (character) {
                ...
                case '"':
                    // End string
                    return this.StringParseResult.success(currentPos - pos, resultBuilder);
                default:
