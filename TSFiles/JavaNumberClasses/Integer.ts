...
export class Integer extends NumberBase {
    ...
    protected initializeBits(decimal: TypeNumericString): TypeInt32 {
        ...
        const abs = negative ? decimal.slice(1) as TypeNumericString : decimal as TypeNumericString;
    ...
    public toLong(): Long {
        ...
        const longBits = Array(32).fill(sign as 0 | 1).concat(this.bits) as TypeInt64;
    ...
    public static subtract(rawNum1: NumberBase, rawNum2: NumberBase): Integer {
        ...
        const bPlus1 = Integer.bitwiseAdd(b, [...Array(31).fill(0), 1] as unknown as TypeInt32);
