...
export class OperatorRegistry {
	...
	register(k: string, { internalName, nicknames, symbol, parsedSignature, interactName, function: Function, serializer }: operatorDataStructure, globalMap: TypeMap) {
		let data = { internalName, nicknames, symbol, interactName, function: Function, serializer } as {
			internalName: string;
			nicknames: string[];
			symbol: string;
			interactName: string;
